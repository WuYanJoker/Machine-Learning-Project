...
# Written by Zehao Yu and Dongze Lian (ASMLP)
# --------------------------------------------------------
...
class AS_MLP(nn.Module):
    r""" ASMLP
        A PyTorch impl of : `ASMLP: An Axial Shifted MLP Architecture for Vision`  -
    ...
    Args:
        ...
        depths (tuple(int)): Depth of each ASMLP layer.
